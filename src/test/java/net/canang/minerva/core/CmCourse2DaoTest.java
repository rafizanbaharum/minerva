...
public class CmCourse2DaoTest extends AbstractTransactionalJUnit4SpringContextTests {

    private Logger log = LoggerFactory.getLogger(CmCourse2DaoTest.class);
    ...
    public void createCourse() {
        ...
        course.setDescription("Introduction to Java programmming");
        course.setKeywords("JVM, Introduction, Java");
    ...
    public void createModule1() {
        log.debug("module");
        CmCourse course = courseDao.findByCode("CS102");
        CmCourseModule module1 = new CmCourseModuleImpl();
        module1.setName("Java Collections");
        module1.setTitle("Java Collection");
        module1.setDescription("This tutorial explains the usage of the Java Collections, e.g. Lists, ArrayLists and Maps");
        module1.setKeywords("Collections, Maps");
        module1.setOrder(1);
        ...
        lesson1.setTitle("Java Collections");
        lesson1.setDescription(" Java Collections");
        ...
        section1.setTitle("Important implementations");
        ...
        content1_1.setTitle("2.1. Map and HashMap");
        ...
        content1_2.setTitle("2.2. List, ArrayList and LinkedList");
