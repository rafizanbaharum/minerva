...
public class DaoSupport<K, I, E> implements InitializingBean {
    ...
    protected void prepareMetadata(I i, CmUser user) {

        if (i instanceof CmMetaObject) {
            CmMetadata metadata = null;
            ...
            ((CmMetaObject) i).setMetadata(metadata);
        }
    }

    protected void prepareFlowdata(I i, CmUser user) {

        if (i instanceof CmFlowObject) {
            CmFlowdata flowdata = null;
            if (((CmFlowObject) i).getFlowdata() != null)
                flowdata = ((CmFlowObject) i).getFlowdata();
            else
                flowdata = new CmFlowdataImpl();
            flowdata.setState(CmFlowState.DRAFTED);
            flowdata.setDraftedDate(new Timestamp(System.currentTimeMillis()));
            flowdata.setDrafter(user.getId());
            ((CmFlowObject) i).setFlowdata(flowdata);
        }
    }
    ...
    public void update(I entity, CmUser user) {
        ...
        ((CmMetaObject) entity).setMetadata(metadata);
     ...
     * @param user
     */
    public void remove(I entity, CmUser user) {
